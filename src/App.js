...
import { firebaseAuth } from './constants/constants'
      ...
      <BrowserRouter>
        <div className="App">
          <nav className="navbar navbar-expand-md navbar-dark bg-primary">
            <Link  style={{ padding: "5px" }} to="/"><img src={Logo} alt="Boarding"  width="100px" height="30px"/></Link>
            ...
            <div className="collapse navbar-collapse" id="navbarColor01" style={{ float: "left"}}>
                {this.state.authed ?
                    ...
                    <ul className="navbar-nav mx-lg-auto ">
                      ...
                      <li className="nav-item active">
                        <Link className="nav-link" href="#" style={{color: 'white'}} to="/mytrips">MyTrips</Link>
                      </li>
