...
export default class Filter extends Component {
  ...
  handleClick() {
    console.log("filter value: " + this.state.value)
  ...
  handleChangeSort(event) {
    ...
    console.log("Sort by: " + this.state.sortValue)
  }
  handleSubmit(event) {
      ...
      <div>
        <form  onSubmit={this.handleSubmit}>
          <div className="card" style={{padding: "20px", margin: "10px"}}>
            ...
            <button type="submit" className="btn btn-primary btn-block" onClick={(this.state.value == "" || this.state.value == null)? () => alert('You need to enter something to search!') : this.handleClick}   >Filter</button>
          </div>
          <br/>
          <br/>
          <div className="card" style={{padding: "20px", margin: "10px"}}>
